/* Description: Creates a transaction input that refers to a created unspent transaction output, that itself refers to a transaction output with an amount of 1B */
